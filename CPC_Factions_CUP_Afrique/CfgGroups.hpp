		...
		class CPC_B_GFD
		{
			...
			class Infantry
			{
				...
				class CPC_B_GFD_InfantrySquad
				{
					...
					{
						side = 1;
						vehicle = "CPC_Duala_B_GFD_soldier_TL";
						rank = "LIEUTENANT";
						position[] = {0,5,0};
					};
					class Unit1
					{
						side = 1;
						vehicle = "CPC_Duala_B_GFD_soldier_MG";
						rank = "SERGEANT";
						position[] = {3,0,0};
					};
					class Unit2
					{
						side = 1;
						vehicle = "CPC_Duala_B_GFD_soldier_AT";
						rank = "CORPORAL";
						position[] = {5,0,0};
					};
					class Unit3
					{
						side = 1;
						vehicle = "CPC_Duala_B_GFD_soldier_GL";
						rank = "CORPORAL";
						position[] = {7,0,0};
					};
					class Unit4
					...
					{
						side = 1;
						vehicle = "CPC_Duala_B_GFD_soldier_LAT";
						rank = "CORPORAL";
						position[] = {11,0,0};
					};
					class Unit6
					...
					{
						side = 1;
						vehicle = "CPC_Duala_B_GFD_soldier_AAT";
						rank = "PRIVATE";
						position[] = {15,0,0};
					};
					class Unit8
					{
						side = 1;
						vehicle = "CPC_Duala_B_GFD_soldier_1";
						rank = "PRIVATE";
						position[] = {17,0,0};
					};
				};
				...
				class CPC_B_GFD_InfantrySectionAA
				{
					...
					{
						side = 1;
						vehicle = "CPC_Duala_B_GFD_soldier_AA";
						rank = "LIEUTENANT";
						position[] = {0,5,0};
					};
					class Unit1
				...
				class CPC_B_GFD_SniperTeam
				{
					...
					{
						side = 1;
						vehicle = "CPC_Duala_B_GFD_soldier_M";
						rank = "SERGEANT";
						position[] = {0,5,0};
					};
					class Unit1
				...
				class CPC_B_GFD_SFTeam
				{
					...
					{
						side = 1;
						vehicle = "CPC_Duala_B_GFD_soldier_SF_TL";
						rank = "SERGEANT";
						position[] = {0,5,0};
					};
					class Unit1
					{
						side = 1;
						vehicle = "CPC_Duala_B_GFD_soldier_SF_Medic";
						rank = "CORPORAL";
						position[] = {3,0,0};
					};
					class Unit2
					{
						side = 1;
						vehicle = "CPC_Duala_B_GFD_soldier_SF_1";
						rank = "PRIVATE";
						position[] = {5,0,0};
					};
					class Unit3
					{
						side = 1;
						vehicle = "CPC_Duala_B_GFD_soldier_SF_MG";
						rank = "PRIVATE";
						position[] = {7,0,0};
					};
					class Unit4
					{
						side = 1;
						vehicle = "CPC_Duala_B_GFD_soldier_SF_M";
						rank = "PRIVATE";
						position[] = {9,0,0};
					};
					class Unit5
			...
			class Motorized
			{
				...
				class CPC_B_GFD_MotorizedInfantrySquad
				{
					...
					{
						side = 1;
						vehicle = "CPC_Afrique_B_GFD_V3S_Covered"; 
						rank = "CORPORAL";
						position[] = {-5,0,0};
					};
					class Unit2
        ...
        class CPC_O_NPFD
        {
            ...
            class Infantry
            {
                ...
                class CPC_O_NPFD_InfSentry
                {
                    ...
                    {
                        side = 0;
                        vehicle = "CPC_Duala_O_NPFD_soldier_1";
                        rank = "PRIVATE";
                        position[] = {5,-5,0};
                    };
                };
                class CPC_O_NPFD_InfSquad
                {
                    name = "Rifle Squad";
                    side = 0;
                    faction = "CPC_O_NPFD";
                    ...
                    {
                        side = 0;
                        vehicle = "CPC_Duala_O_NPFD_soldier_officer";
                        rank = "SERGEANT";
                        position[] = {0,0,0};
                    };
                    class Unit1
                    {
                        side = 0;
                        vehicle = "CPC_Duala_O_NPFD_soldier_TL";
                        rank = "SERGEANT";
                        position[] = {5,-5,0};
                    };
                    class Unit2
                    {
                        side = 0;
                        vehicle = "CPC_Duala_O_NPFD_soldier_AR";
                        rank = "CORPORAL";
                        position[] = {-5,-5,0};
                    };
                    class Unit3
                    {
                        side = 0;
                        vehicle = "CPC_Duala_O_NPFD_soldier_AT";
                        rank = "PRIVATE";
                        position[] = {10,-10,0};
                    };
                    class Unit4
                    ...
                    {
                        side = 0;
                        vehicle = "CPC_Duala_O_NPFD_soldier_Medic";
                        rank = "CORPORAL";
                        position[] = {15,-15,0};
                    };
                    class Unit6
                ...
                class CPC_O_NPFD_InfSquad_Weapons
                {
                    name = "Weapons Squad";
                    side = 0;
                    faction = "CPC_O_NPFD";
                    ...
                    {
                        side = 0;
                        vehicle = "CPC_Duala_O_NPFD_soldier_4";
                        rank = "PRIVATE";
                        position[] = {-15,-15,0};
                    };
                    class Unit6
                ...
                class CPC_O_NPFD_InfWepTeam
                {
                    ...
                    {
                        side = 0;
                        vehicle = "CPC_Duala_O_NPFD_soldier_MG";
                        rank = "CORPORAL";
                        position[] = {3,0,0};
                    };
                    class Unit2
                    ...
                    {
                        side = 0;
                        vehicle = "CPC_Duala_O_NPFD_soldier_5";
                        rank = "PRIVATE";
                        position[] = {7,0,0};
                    };
                };
                class CPC_O_NPFD_InfSupTeam
                {
                    name = "Support Team";
                    side = 0;
                    faction = "CPC_O_NPFD";
                    ...
                    {
                        side = 0;
                        vehicle = "CPC_Duala_O_NPFD_soldier_sniper";
                        rank = "PRIVATE";
                        position[] = {7,0,0};
                    };
                };
                class CPC_O_NPFD_InfHQ
                {
                    name = "Infantry HQ";
                    side = 0;
                    faction = "CPC_O_NPFD";
                    ...
                    {
                        side = 0;
                        vehicle = "CPC_Duala_O_NPFD_soldier_ENG";
                        rank = "PRIVATE";
                        position[] = {7,0,0};
                    };
                    class Unit4
            ...
            class Motorized
            {
                ...
                class CPC_O_NPFD_MotInf_Team
                {
                    ...
                    {
                        side = 0;
                        vehicle = "CPC_Duala_O_NPFD_Datsun";
                        rank = "SERGEANT";
                        position[] = {0,-10,0};
                    };
                    class Unit2
                ...
                class CPC_O_NPFD_Technicals
                {
                    ...
                    {
                        side = 0;
                        vehicle = "CPC_Duala_O_NPFD_Datsun_PK";
                        rank = "SERGEANT";
                        position[] = {0,0,0};
                    };
                    class Unit1
