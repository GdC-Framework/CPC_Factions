...
class CfgPatches
{
	class CPC_Factions_CUP_Latin
	{
		units[] =
		{
			...
			"CPC_LAT_B_EJE_C47",
			"CPC_LAT_B_EJE_CESSNA_T41_ARMED",
			"CPC_LAT_B_EJE_M119",
			...
			"CPC_LAT_I_PIC_Hilux_unarmed",
			"CPC_LAT_I_PIC_Hilux_DSHKM",
			"CPC_LAT_I_PIC_Hilux_SPG9",
			"CPC_LAT_I_PIC_Hilux_metis",
			"CPC_LAT_I_PIC_Hilux_MLRS",
			"CPC_LAT_I_PIC_Hilux_zu23",
			"CPC_LAT_I_PIC_Hilux_M2",
			"CPC_LAT_I_PIC_Hilux_UB32",
