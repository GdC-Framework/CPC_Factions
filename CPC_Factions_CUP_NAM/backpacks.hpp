	...
	class  CPC_NAM_Backpack_US_SF_GL: CUP_B_AlicePack_OD
	{
		scope = 1;
		scopeArsenal = 0;
		author = "CPC Faction";
	...
	class CPC_NAM_Backpack_US_SF_MG: CUP_B_AlicePack_OD
	{
		scope = 1;
		scopeArsenal = 0;
		author = "CPC Faction";
	...
	class CPC_NAM_Backpack_US_SF_ENG: CUP_B_AlicePack_OD
	{
		scope = 1;
		scopeArsenal = 0;
		author = "CPC Faction";
	...
	class CPC_NAM_Backpack_US_SF_TL: CUP_B_AlicePack_OD
	{
		scope = 1;
		scopeArsenal = 0;
		author = "CPC Faction";
		...
		class TransportMagazines
		{
			...
			class _xx_CUP_20Rnd_556x45_Stanag_Tracer_Red
			{
				magazine = "CUP_20Rnd_556x45_Stanag_Tracer_Red";
				count = 6;
			};
		};
	};
	class CPC_NAM_Backpack_US_SF_M: CUP_B_AlicePack_OD
	{
		scope = 1;
		scopeArsenal = 0;
		author = "CPC Faction";
